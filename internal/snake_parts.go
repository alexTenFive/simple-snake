...
func loadSnakeSprites() error {
	...
	snakeParts[SnakeBodyOnePart], _, err = ebitenutil.NewImageFromFile("../assets/sprites/snake_body_one.png")
	if err != nil {
		return err
	}
	snakeParts[SnakeBodyTwoPart], _, err = ebitenutil.NewImageFromFile("../assets/sprites/snake_body_two.png")
	if err != nil {
		return err
	}
